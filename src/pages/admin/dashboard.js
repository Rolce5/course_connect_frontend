...
const AdminDashboardPage = () => {
  ...
  const [dashboardData, setDashboardData] = useState({
    stats: { totalStudents: 0, totalCourses: 0 },
    recentCourses: [],
    recentEnrollments: [],
  });
          ...
          <div className="h-64">
            <div className="flex h-full items-center justify-center rounded-lg bg-gray-50">
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Course distribution chart will appear here
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      {course.enrollments?.length || 0} student
                      {course.enrollments?.length > 1 ? "s" : ""} •
                      {course.is_active === "active" ? "Published" : "Draft"}
                    </p>
                  </div>
