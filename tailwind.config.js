...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'custom-gradient': 'linear-gradient(180deg, #511D28 15.1%, rgba(108, 40, 53, 0) 48.44%, rgba(92, 26, 36, 0.69) 100%)',
        'custom-gradient-1': 'linear-gradient(180deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 51.04%, rgba(0, 0, 0, 0.2) 100%)',
      },
      fontFamily: {
        poppins: ['Poppins'],
      },
      ...
      boxShadow: {
        ...
        'sidebar-active': '0 4px 6px -1px rgba(52, 152, 219, 0.3), 0 2px 4px -1px rgba(52, 152, 219, 0.2)',
      },
      // Custom spacing
      spacing: {
